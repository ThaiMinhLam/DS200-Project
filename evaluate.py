...
class VLSP2018SklearnEvaluator:
    ...
    def save_html_report(self, filename="absa_report.html"):
        ...
        for key, merged_metrics in self.merged_report.items():
            if key in ['accuracy', 'macro avg', 'weighted avg']:
                continue
        ...
        <head>
            <meta charset="UTF-8">
            <title>ABSA Evaluation Report</title>
            <style>
                table, th, td {{
        ...
        print(f"✅ Saved ABSA evaluation report to {filename}")