...
def extract_price(text):
    price_keywords = [
        ...
        r"\b(chi phí|tốn|cắt cổ|treo đầu dê bán thịt chó|bỏ ra|số tiền|tiền vé|phí tham gia|phí tham quan)\b"
    ...
    if existAspect:
        positive_patterns = [
            r"\b(giá tour|giá|vé|phí|tour).{0,10}?(rẻ|hạt dẻ|bình dân|hợp lý|ổn áp|tiết kiệm|hời|bèo|sinh viên|phải chăng|tốt|hấp dẫn|mềm|acceptable|reasonable|affordable)\b",
            r"\b(xứng đáng|đáng đồng tiền|vừa túi tiền|hợp túi tiền|đáng giá|rất đáng|giảm giá|ưu đãi|phù hợp túi tiền|chất lượng tương xứng)\b",
            r"\b(happy hour|khuyến mãi|giảm giá|promotion).{0,10}?(đáng giá|tốt|hời|worth it)\b",
            r"\b(rẻ hơn|tốt hơn|hợp lý hơn).{0,10}?(mong đợi|dự kiến|so với|đa số|chỗ khác|tự đi|tự thuê|đặt riêng|chỗ khác)\b",
            r"\b(giá cả không thể tốt hơn|perfect price|great value for money)\b",
            r"\btour.{0,15}?(giá rẻ|hợp lý|đáng đồng tiền)\b"
        ]
        negative_patterns = [
            r"\b(giá tour|giá|vé|phí|tour|tiền).{0,10}(bất hợp lý|khủng khiếp|cao|đắt|đắt đỏ|mắc|cắt cổ|không hợp lý|không đáng|không xứng|chát|sốc|expensive|overprice|trên trời|vô lý|ảo)\b",
            r"\b(không đáng|tốn tiền|không đáng tiền|không xứng|không hợp lý|too expensive|not worth it|bị chặt chém|bị hố)\b",
            r"\b(quá |rất )?(đắt|cao|mắc)( hơn)?.{0,10}(số tiền bỏ ra|đáng|mong đợi|dự kiến|đa số|chỗ khác|dịch vụ|nhận được|tự đi|tự thuê|đặt riêng)?\b",
            r"\bmất tiền.{0,5}mà không.{0,5}xứng đáng\b",
            r"\b(tip|bo).{0,10}?(bắt buộc|ép|đòi|nhiều|quá đáng)\b",
            r"\b(happy hour|khuyến mãi|giảm giá).{0,10}?(vẫn đắt|không đáng|not worth)\b",
            r"\b(tự túc rẻ hơn|tự đi tiết kiệm hơn|không cần tour)\b",
            r"\b(giá cao nhưng chất lượng thấp|không xứng với giá tiền|tiền mất tật mang)\b",
            r"\b(combo|gói|tour).{0,10}?(không như|khác xa).{0,10}?(mô tả|review|quảng cáo)\b",
            r"\b(giá )?tour.{0,15}?(đắt|mắc|cao|cắt cổ|không đáng)\b"
        ]
...
def extract_service_staff(text):
    ...
    if existAspect:
        positive_patterns = [
            r"(?<!\bchưa\s)\b(nhanh nhẹn|tận tình|hòa đồng|dễ mến|hết lòng|rất ok|tuyệt vời|tốt|chuyên nghiệp|xuất sắc|đáng khen|hoàn hảo|vui tính|nhiệt tình|dễ thương|vui vẻ|hiếu khách|lịch sự|thân thiện|niềm nở|nhẹ nhàng|tận tâm|chu đáo|quan tâm|tử tế|dễ tính)\b",
            r"\b(am hiểu|service tốt|hiệu quả)\b",
            r"\bhướng dẫn viên.{0,10}?(thuyết minh|giới thiệu).{0,10}?(rất hay|hấp dẫn|sinh động)\b",
            r"\b(hướng dẫn|tư vấn|giúp đỡ|chăm sóc|hỗ trợ|quan tâm).{0,10}?(kỹ|tốt|tận tình|rất tốt|chu đáo|từng bước)\b",
            r"\b(ấn tượng|hài lòng|thích).{0,10}?(với|về).{0,10}?(nhân viên|hướng dẫn viên|đội ngũ)\b",
            r"\b(luôn mỉm cười|luôn tươi cười|nụ cười|thái độ tích cực)\b",
            r"\b(sẽ quay lại|giới thiệu bạn bè|recommend).{0,10}?(vì|do).{0,10}?(nhân viên|hướng dẫn viên|đội ngũ)\b",
        ]
        negative_patterns = [
            r"\b(cục súc|tiêu cực|không tốt|thái độ|phục vụ chậm|thô lỗ|tệ|khó chịu|cộc cằn|gắt|khó ưa|thờ ơ|lạnh nhạt|vô duyên|khinh khỉnh|kiêu kỳ|láo|mất dạy|bất lịch sự|vô lễ|quát|hỗn|mắng|chửi|đe dọa|chậm chạp)\b",
            r"\b(lờ đi|quay lưng|thái độ phân biệt|phớt lờ|bỏ mặc|không quan tâm|quát nạt|chỉ trích|phân biệt đối xử|đòi tiền tip|vòi vĩnh|chèn ép)\b",
            ...
            r"\b(không|thiếu).{0,10}(hướng dẫn|thèm nhìn|chuyên nghiệp|chú ý|ổn|thân thiện|nhiệt tình|hợp tác|chăm sóc|quan tâm|hiểu biết|hỗ trợ|giúp đỡ|am hiểu)\b",
            r"\b(tránh xa|không nên|đừng).{0,10}?(vì|do).{0,10}?(nhân viên|hướng dẫn viên|đội ngũ)",
...
def extract_environment_atmosphere(text):
    ...
    if existAspect:
        positive_patterns = [
            r"\b(chill|dễ chịu|thoải mái|thư thái|tuyệt vời|ấn tượng|tuyệt hảo|hoàn hảo|tuyệt trần|thoáng đãng)\b",
...
def extract_experience_activity(text):
    experience_activities_keywords = [
        ...
        r"\b(trải nghiệm văn hoá|văn nghệ|biểu diễn|show|ca nhạc|kịch|múa rối|ẩm thực|nếm thử)\b",
    ...
    if existAspect:
        positive_patterns = [
            r"\b(chill|bao vui|nhiều niềm vui|tuyệt vời|hấp dẫn|thú vị|đỉnh cao|đáng giá|đáng trải nghiệm|ấn tượng|khó quên|tuyệt hảo)\b",
            ...
            r"\b(đáng đồng tiền|giá trị|không uổng công|không thất vọng|vượt mong đợi)\b",
        ...
        negative_patterns = [
            ...
            r"\b((không phù hợp.{0,10}(với trẻ em|cho người già))|nhàm chán)\b",
...
if __name__ == '__main__':
    ...
    df = pd.read_csv("./DatasetGGMaps/final_review_googlemap_comments_tour.csv", index_col=0) 
    df = append_aspects(df, processor)
    df.to_csv('./annotated_labels/list_aspects_tours.csv')